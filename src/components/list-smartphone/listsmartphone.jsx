...
export default function Listsmartphone() {
  ...
  return (
    <div className="py-5 px-4">
      <h1 className="text-center">Liste des Smartphones</h1>
      {isLoading ? (
        <h1 className="mt-3"> données en chargement</h1>
      ) : (
        <div className="container py-5">
          <div className="row">
            {smartphones.filter((smartphone) => smartphone.nom.toLowerCase().includes(searchValue)).map((smartphone) => (
                ...
                <div className="card mb-4">
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex justify-content-between">
                      <Link to={`/detail-smartphone/admin/${smartphone.id}`} className="btn btn-primary">Details</Link>

                      {isAuthenticated ? (
                        <>
                          <Link to={`/edit-smartphone/admin/${smartphone.id}`} className="btn btn-warning">Modifier</Link>
                          <button
